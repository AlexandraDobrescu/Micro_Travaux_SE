    ...
    with open(working_dir+argv[1], 'r') as f:
        ...
        for line in f:
            if line [0:3] == "air":
                ...
                # indexAir = indexAir + 1
                print "Flight no." + airThread[airQueue.qsize()-1] + " has joined the AIR queue.\r\n"
                ...
                print "Flight no." + groundThread[groundQueue.qsize()-1] + " has joined the GROUND queue.\r\n" 

            elif line [0] == " ":
                while not( airQueue.empty() ) or not( groundQueue.empty() ):
                    # print indexAir
                    # print indexGround
                    print "There are " + str(airQueue.qsize()) + " in the AIR queue.\r\nThere are " + str(groundQueue.qsize()) + " on the GROUND queue.\r\n"
